# T6: Reset-policy selection

**Category:** Implicit assumptions

**Targeted reasoning challenge:** Make and state a correct synchronous/asynchronous reset choice.
...
## Expected validation
Compile with GHDL/VCS-equivalent simulator and run `tb_t6_reset_policy_selection.vhd`.
