# T15: Multi-output frequency divider

**Category:** Constraints

**Targeted reasoning challenge:** Duty-cycle correctness and generated-clock awareness.
...
## Expected validation
Compile with GHDL/VCS-equivalent simulator and run `tb_t15_multi_output_frequency_divider.vhd`.
